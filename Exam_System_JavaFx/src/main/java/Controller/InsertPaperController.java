...
public class InsertPaperController {
    ...
    public void InsertPaper(Connection connection,String paperName) throws SQLException {
        ResultSet questionBank = JDBCUtil.selectAll("Test_question_bank", connection);
        ...
        //定义sql
        String sql = "insert into " + paperName + "(subject, type, title, tk, choiceA, choiceB, choiceC, choiceD, difficulty) values (?,?,?,?,?,?,?,?,?)";
    ...
    void InsertPaperOnAction(ActionEvent event) throws SQLException {
        ...
        if (!empty) {
            ...
            //定义sql
            String sql1 = "select * from PaperSource";
            ...
            if (!flag) {
                String sql3 = "create table " + paperName.getText() + "(\n" +
                        ...
                        "    paperName varchar(500) comment '试卷名称'\n" +
                        ")comment '试卷';";
            ...
            //关闭资源
            JDBCUtil.closeAll(null, null, connection);
            JDBCUtil.closeAll(rs, ps1, null);
    ...
    boolean isEmpty(){
        boolean flag = false;
        if (paperName.getText() != null && subject.getText() != null){
            flag =true;
        }
        return flag;
    }
